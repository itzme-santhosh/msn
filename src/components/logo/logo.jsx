...
export const Logo = forwardRef(
  ...
  */
    const logo = (
      ...
      >
        <path
          ...
          d="m0 0h666l12 2 9 5 3 2v2l4 2 6 9 3 8v683l-4 10-7 9-8 6-8 4-8 1h-671l-11-2-11-7-8-9-4-8-1-6v-679l2-9 8-11 7-6 7-4z"
          fill="#004C82"
        />
        <path
          transform="translate(226,166)"
          d="m0 0h199l27 3 5 2 14 3 10 3 26 11 8 5 8 4 12 9 14 11v2l3 1 5 5 9 10 9 12 8 13 9 17 4 9 2 7 2 5 2 8 5 23 1 14v30l-1 14-5 21-3 12-2 3-2 7-8 16-7 13-8 11-8 10-11 12-12 11-11 8-8 6-6 3-15 8-18 7-10 3-15 4-36 4-57 2-5-3 4-6 19-19h2l1-3 6-5 5-5 4-5 8-7 7-7 8-3 18-2 17-5 16-6 9-5 11-7 11-9 12-13 7-10 8-13 8-19 3-11 3-14v-31l-4-19-7-19-9-16-8-11-8-10-8-7-12-9-17-10-14-5-19-5-17-2-17-1h-86l-48 1-6 1v245h2l11-11 5-4 3-4h2l1-3h2l2-4 7-7h2l2-4 5-4 7-8 6-6h2l2-4h2v-2l5-5h2l1-3 5-5 8-7 2-3h2l2-4h2l1-3h2l2-4h2l1-3 4-4h2l2-4 8-7 7-8-1-5-1-3-4-2-47-44-8-8-3-2v-2l-4-2-5-5v-5l4-3h78l10 9 10 10v2l4 2 3 3v2h2l7 8 19 19 7 8 15 15 4 5-1 4-6 7-8 7-10 11-8 7-52 52h-2l-1 3h-2l-2 4-18 18h-2l-2 4h-2v2l-5 5h-2l-2 4-3 3h-2l-2 4h-2l-1 3-4 4h-2l-2 4h-2l-1 3-6 5-86 86h-2l-2 4-8 7-2 3h-2l-2 4h-2l-1 3h-2l-2 4-7 6-3-1v-454l2-2z"
          fill="#FCFCFD"
        />
      </svg>
    );
    ...
    const singleLogo = (
      <svg
        version="1.1"
        viewBox="2439.521 -1851.083 4554.651 3588.58"
        style={{ enableBackground: 'new 2439.521 -1851.083 4554.651 3588.58' }}
      >
        <g id="Layer_1" />
        <g id="Layer_2" />
        <g id="Dimensions">
          <rect x="2439.521" y="-1851.083" fill="#FFFFFF" width="4554.651" height="3588.58" />
          <g id="Layer_x5F_1">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              fill="#FF0408"
              d="M5536.795,640.442c-9.048,31.179-25.909,70.543-64.737,73.085
            c-68.001,4.454-101.162-141.133-118.139-191.061c-77.12-226.904-151.044-463.393-233.737-687.313
            c-12.5-33.837-92.044-245.747-151.65-217.879c-111.237,52.004-204.237,412.789-268.554,462.297
            c-54.546,41.976-117.44,10.331-132.832-58.114c-8.488-37.732,18.19-189.802-14.598-194.466c-4.804-0.676-9.888-0.793-15.182-0.42
            c-46.5,142.462-114.175,283.502-170.866,357.24c-60.632,78.869-168.861,156.874-254.819,62.475
            c-128.097-140.667,171.239-507.631,397.841-554.015c40.087-118.279,70.636-247.939,14.901-251.973
            c-26.398-1.912,13.409,2.798-19.962-1.563c38.151-42.513,74.788,2.076,83.579,48.016c10.051,52.493,3.708,123.876-12.989,201.835
            c27.331,3.102,52.54,12.71,74.415,30.153c20.591,16.417,34.933,35.143,44.914,55.362
            c50.698-103.448,110.281-207.362,190.852-257.85c191.714-120.098,295.932,145.354,338.958,284.202
            c81.247,262.141,149.295,544.967,211.023,812.775c23.367,101.302,45.427,69.937,101.536,27.214H5536.795z"
            />
          </g>
        </g>
        <g id="Layer_4" />
