...
export const _featuredServices = [...Array(6)].map((_, index) => ({
  id: _mock.id(index),
  title: _mock.serviceNames(index),
  coverUrl: _mock.image.service(index),
  totalDuration: 220,
  totalStudents: _mock.number.nativeM(index),
  price: _mock.number.price(index),
}));
export const _newNoteworthy = [...Array(6)].map((_, index) => ({
  id: _mock.id(index),
  title: _mock.serviceNames(index),
  coverUrl: _mock.image.noteworthy(index),
}));
...
export const _homeCareServices = [...Array(7)].map((_, index) => ({
  id: _mock.id(index),
  title: _mock.homeCareServiceNames(index),
  coverUrl: _mock.image.homeCareService(index),
  totalDuration: 220,
  totalStudents: _mock.number.nativeM(index),
  price: _mock.number.price(index),
}));

export const _foodServices = [...Array(6)].map((_, index) => ({
  id: _mock.id(index),
  title: _mock.foodServiceNames(index),
  coverUrl: _mock.image.foodService(index),
  totalDuration: 220,
  totalStudents: _mock.number.nativeM(index),
  price: _mock.number.price(index),
}));

export const _kidsServices = [...Array(8)].map((_, index) => ({
  id: _mock.id(index),
  title: _mock.kidsServiceNames(index),
  coverUrl: _mock.image.kidsService(index),
  totalDuration: 220,
  totalStudents: _mock.number.nativeM(index),
  price: _mock.number.price(index),
}));

export const _financeServices = [...Array(8)].map((_, index) => ({
  id: _mock.id(index),
  title: _mock.financeServiceNames(index),
  coverUrl: _mock.image.financeService(index),
  totalDuration: 220,
  totalStudents: _mock.number.nativeM(index),
  price: _mock.number.price(index),
}));
