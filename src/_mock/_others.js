...
export const _notifications = [...Array(9)].map((_, index) => ({
  ...
  title:
    ...
    (index === 1 &&
      `<p><strong>Jayvon Hull</strong> mentioned you in <strong><a href='#'>Promon UI</a></strong></p>`) ||
    (index === 2 &&
...
export const _mapContact = [
  {
    zipcode: 78613,
    latlng: [30.5146, -97.8303],
    address: '123 Main St, Cedar Park, TX',
    phoneNumber: '123-456-7890',
  },
  {
    zipcode: 78628,
    latlng: [30.6688, -97.7088],
  ...
  {
    zipcode: 78702,
    latlng: [30.2601, -97.7189],
    address: '123 Main St, East Austin, TX',
    phoneNumber: '123-456-7890',
  },
  {
    zipcode: 78704,
    latlng: [30.2457, -97.7609],
    address: '123 Main St, South Congress, TX',
    phoneNumber: '123-456-7890',
  },
  {
    zipcode: 78705,
    latlng: [30.2906, -97.7421],
    address: '123 Main St, University of Texas Area, TX',
    phoneNumber: '123-456-7890',
  },
  {
    zipcode: 78717,
    latlng: [30.4975, -97.7331],
    address: '123 Main St, Avery Ranch, TX',
    phoneNumber: '123-456-7890',
  },
  {
    zipcode: 78731,
    latlng: [30.3425, -97.7693],
    address: '123 Main St, Northwest Hills, TX',
    phoneNumber: '123-456-7890',
  },
  {
    zipcode: 78741,
    latlng: [30.2316, -97.7233],
    address: '123 Main St, Riverside, TX',
    phoneNumber: '123-456-7890',
  },
  {
    zipcode: 78745,
    latlng: [30.2131, -97.7972],
    address: '123 Main St, South Austin, TX',
    phoneNumber: '123-456-7890',
  },
  {
    zipcode: 78750,
    latlng: [30.4164, -97.8067],
    address: '123 Main St, Anderson Mill, TX',
    phoneNumber: '123-456-7890',
  },
  {
    zipcode: 78759,
    latlng: [30.402, -97.7593],
